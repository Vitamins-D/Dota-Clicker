...
local difficulty = 2
local difficulties = {
	{WAVE_INTERVAL = 30, LVLUP_INTERVAL = 30, GOLD_INTERVAL = 60, MAX_UNITS = 30, GOLD_GIVE = 1500, LVL_GIVE = 1.5, AI_DIF = 1},
	{WAVE_INTERVAL = 60, LVLUP_INTERVAL = 60, GOLD_INTERVAL = 120, MAX_UNITS = 20, GOLD_GIVE = 1000, LVL_GIVE = 1, AI_DIF = 1},
	{WAVE_INTERVAL = 40, LVLUP_INTERVAL = 60, GOLD_INTERVAL = 180, MAX_UNITS = 20, GOLD_GIVE = 900, LVL_GIVE = 0.9, AI_DIF = 2},
	{WAVE_INTERVAL = 30, LVLUP_INTERVAL = 60, GOLD_INTERVAL = 180, MAX_UNITS = 15, GOLD_GIVE = 150, LVL_GIVE = 0.75, AI_DIF = 3},
}
...
function dota_clicker:dotaClickerStart()
	...
	Timers:CreateTimer(GOLD_INTERVAL, function()
		GiveGoldPlayers(math.ceil(GOLD_GIVE/playerCount))
