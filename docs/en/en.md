...
The blue area is the place where improvement points are obtained.

the yellow line is the route of the liner creeps
the purple line is the road to Roshan
the green line is the route of the caravan (from the red base to the lower towers)

The red buildings on the top right represent the enemy's base.
The green buildings on the bottom left are your base.
...
    Selling units returns you 75% of their value.
...
    Also, in order to upgrade an evolution/subclass, you need to meet the requirements for upgrading basic upgrades. All this is described in the description of leveling evolutions and subclasses.

## What is OU, how to earn them and where to look for them?

    OH, these are, as mentioned earlier, improvement points. They are needed to upgrade units, from basic upgrades to upgrades for subclasses and evolutions.
...
1. Statistics on mining by a miner (we'll get to that later and talk more about it)

2. The statistics of our miner
   
   1. Number of forest balvans - how many creeps are there in YOUR camp for mining
   
   2. Bounty for a fool - what number of OU do you get if YOU or your HUNTER kills YOUR creep from YOUR camp

3. Improvement points - current number of OU

4. Roshan Points - special upgrades that are needed to gain special skills for units (more on them later)

    After a lyrical digression, we return to our hunter. To speed up the extraction of op-amp, we need to pump it. 
...
# Chapter 2: What's with the money?

    We have 4 ways to earn money: The Forest, the line that your units follow, the mine, and the looting of caravans.

## Forest

        In addition to earning OU, we can also earn gold, but for this you need to be near any of the existing creep boars there at the time of his death, in a small radius, all players there will be poured a small amount of gold.
...
    If you are not interested in helping your hunter or clicking in the mine, then just go to the line where the battles are taking place between you and the creeps of the bot. If you are around when the creep dies, you will also receive some gold and your income will be generated from this (gold is given for each dead ENEMY creep in a small radius)

## The caravan

    This is one of the most gambling variations of earnings in the custom. Here you will have to calculate the cost of your attack squad (the "Caravan" button in the menu). First, you form an attack squad (it will reset to zero after it leaves and you will need to purchase again), every 3 minutes your and enemy units will leave, and if you kill the entire enemy caravan, then all members of your team will receive some gold. Here you must allocate your resources wisely in order to make a profit.
...
    Also, when the time comes for the caravan to remind you about it 10 seconds before it leaves the map, you will receive a ping.
...
Go back to the main page [Home](../index.md )
